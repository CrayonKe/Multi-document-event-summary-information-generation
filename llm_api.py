...
# default_api_key = "sk-sIFCwrxUjsSyMpb122TStdTGjY2INyEjcsZzacG7mhd97Mfv"
# # default_api_key = "sk-lW9U01MGt7bJ4BZCPR8gUaA5dVwFDuis8P2a9TzLKcaQL31h"
# default_base_url = "https://api.chatanywhere.tech"
# default_model_name = "gpt-4o-2024-08-06"

default_api_key = "kw-8WIwNEMt3Ln1EFWBfY7pgDqHetTdeFg4Fi3f05OxNYsJRyam"
default_base_url = "http://10.176.40.145:8502"
default_model_name = "gpt-4o-2024-08-06"
...
def llm_query0(prompt):
    ...
    aaa = requests.post(
        ...
        json={
            ...
            "name_key":
            "EexJEkPXMlL8Dy6qFIT95MTkiJGAsocEjkrgVRrauvDOibfwmvIr46cQ9/qOj2OzYpSNuDvUSwDPAgJCWM7z2g==",
            "messages": [
                {
                    "role": "user",
                    "content": prompt,
...
def llm_query_img(use_config=default_config,
                  msgs=default_msgs,
                  file=None,
                  prompt=None):
    if type(file) == list:
